...
@WebServlet(name = "IsMyTurnServlet", urlPatterns = {"/GameRoom/isMyTurn"})
public class IsMyTurnServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        SimpleResultDto result = gameRoom.isMyTurn(userName);
