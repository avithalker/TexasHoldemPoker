...
@WebServlet(name = "IsComputerTypeServlet", urlPatterns = {"/GameRoom/isComputerType"})
public class IsComputerTypeServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        SimpleResultDto resultDto = gameRoom.isComputerType(userName);
