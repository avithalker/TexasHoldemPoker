...
@WebServlet(name = "IsHandStartedServlet", urlPatterns = {"/GameRoom/isHandStarted"})
public class IsHandStartedServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        SimpleResultDto resultDto = new SimpleResultDto(gameRoom.isHandRoundStarted());
